...
def train(args):
    ...
    config["data_loader"]["train"]["args"].update({"sequence": "outdoor_day1", "event_interval": args.event_interval})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', default=4e-4, type=float, help='learnning rate')
